...
{
    public class ReceivingListRevRepository
    {
        private ReceivingListRevRepository() { }

        #region Singleton
        private static ReceivingListRevRepository instance = null;
        public static ReceivingListRevRepository Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = new ReceivingListRevRepository();
                }
                return instance;
            }
        }
        ...
        public int countReceivingList(string dnNoSearch, string poNoSearch, string supplierSearch, string poDateSearch, 
            string statusSearch, string poTextSearch, string receivingDateSearch, string matDocNoSearch, string unitCode, string noReg)
        {
            ...
            return db.SingleOrDefault<int>("CountReceivingListRev", args);
        }

        public List<GR_IR_DATA> GetReceivingList(string dnNoSearch, string poNoSearch, string supplierSearch, string poDateSearch,
            string statusSearch, string poTextSearch, string receivingDateSearch, string matDocNoSearch, 
            string unitCode, string noReg, int fromNumber, int toNumber)
        {
            string receivingDateSearchFrom = "";
            string receivingDateSearchTo = "";
            if (receivingDateSearch != null && !"".Equals(receivingDateSearch))
            ...
            List<GR_IR_DATA> result = db.Fetch<GR_IR_DATA>("GetReceivingListRev", args);
            db.Close();
            return result;
        }

        public List<String> GetReceivingListSort(string dnNoSearch, string poNoSearch, string supplierSearch, string poDateSearch,
            string statusSearch, int fromNumber, int toNumber, string field, string sort)
        {
            ...
            switch (field)
            {
                case "PO_NUMBER":
                    ...
                    break;
                case "DN_NO":
                    returnResult = ((sort == "asc" || sort == "none") ? resultItem.OrderBy(o => o.DN_NO).ToList() : resultItem.OrderByDescending(o => o.DN_NO).ToList());
                    break;
                case "DN_NO_ITEM":
                    returnResult = ((sort == "asc" || sort == "none") ? resultItem.OrderBy(o => o.DN_NO_ITEM).ToList() : resultItem.OrderByDescending(o => o.DN_NO_ITEM).ToList());
                    break;
                case "PO_ITEM":
        ...
        public AjaxResult ApproveGR(IDBContext db, string grIrId, string NoReg)
        {
            //IDBContext db = DatabaseManager.Instance.GetContext();
        ...
        public List<GR_IR_DATA> GetReceivingListExcel(string dnNoSearch, string poNoSearch, string receivingDateSearch,
