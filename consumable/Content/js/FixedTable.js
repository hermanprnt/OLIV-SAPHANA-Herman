...
$.remakeFixedTable2 = function (idx) {
    $.initFixedTable2(idx);
    $.resetFixedTable2(idx);
};
...
$.initFixedTable2 = function (idx) {
    ...
    */
    ...
    var mainContainer = document.getElementsByClassName("afixed-main-container")[idx];
    if (mainContainer !== undefined) {
        var baseContainer = $(mainContainer).find(".afixed-table-container")[0];
        var baseViewport = $(mainContainer).find(".afixed-table-viewport")[0];
        var baseTable = $(mainContainer).find(".afixed-table")[0];
