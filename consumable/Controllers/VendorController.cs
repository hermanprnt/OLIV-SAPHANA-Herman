...
namespace consumable.Controllers
{
    public class VendorController : PageController
    {
        ...
        public void constructComboBoxes()
        {
            ...
            List<Supplier> listWithHoldingTax = (List<Supplier>)supplierRepo.GetByWithHoldingTax(CommonConstant.WITHOLDING_TAX);
            ViewData["WithHoldingTaxList"] = listWithHoldingTax;
        }
