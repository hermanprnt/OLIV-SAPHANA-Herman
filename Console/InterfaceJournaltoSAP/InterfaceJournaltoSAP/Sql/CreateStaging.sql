...
FROM (
	SELECT DISTINCT D.GR_ITEM
		...
		,'0000000.00' ITEM_QTY
		,'' UOM
		,'0000000.00' STD_UNIT_COST
		,'0000000.00' STD_COST_AMT
		,'0000000.00' STD_TTL_AMT
		,'0000000.00' ACT_UNIT_COST
		,'0000000.00' ACT_COST_AMT
		,RIGHT('000000000000000000' + CONVERT(VARCHAR(21), E.MATDOC_AMOUNT), 21) ACT_TTL_AMT
		,'0000000.00' VARIANCE_AMT
		...
		,ISNULL((
				SELECT TOP 1 RIGHT('00000000000' + CONVERT(VARCHAR(14), GG.AMOUNT), 14)
