...
SELECT DISTINCT INVOICE_ID
	...
	,PAY_METHOD
	,BASE_DATE
	,CONVERT(VARCHAR, TAX_DATE, 112) TAX_DATE
...
SELECT DISTINCT A.INVOICE_ID
	...
	,CONVERT(VARCHAR, A.GR_POSTING_DATE, 112) GR_POSTING_DATE
...
FROM (
	SELECT DISTINCT D.GR_ITEM
		...
		,'' REFF_CUSTOMER_INV_NO
		,E.GR_POSTING_DATE ORACLE_CUST_CD
		,'' CUST_CD
		,'' ORACLE_CUST_PLANT_CD
		,'' CUST_PLANT_CD
		...
		,RIGHT('000000000000000000' + CONVERT(VARCHAR(21), ABS(A.TOTAL_AMOUNT) + ISNULL((
				SELECT TOP 1 AG.AMOUNT
